...
'balance-correction/new': [
        [
            Insert_balance_correction_new
        ],
        unknown
    ];
'balance-correction/update': [
        [
            Update_balance_correction_update
        ],
        unknown
    ];
'buckets/all': [
...
'buckets/set-archive': [
        [
            Update_buckets_set_archive
        ],
        unknown
    ];
'buckets/update': [
        [
            Update_buckets_update
        ],
        unknown
    ];
'buckets/from-id': [
...
'miles/archived': [
        [
            Select_miles_archived
        ],
        Miles
    ];
'miles/from-id': [
        [
            Select_miles_from_id
        ],
        Miles
    ];
'miles/new': [
...
'subscriptions/active': [
        [
            Select_subscriptions_active
        ],
        Subscriptions
    ];
'subscriptions/archived': [
        [
            Select_subscriptions_archived
        ],
        Subscriptions
    ];
...
'subscriptions/from-id': [
        [
            Select_subscriptions_from_id
        ],
        Subscriptions
    ];
'subscriptions/new': [
        [
            Insert_subscriptions_new
        ],
        unknown
    ];
'subscriptions/set-archive': [
        [
            Update_subscriptions_set_archive
        ],
        unknown
    ];
'subscriptions/update': [
        [
            Update_subscriptions_update
        ],
        unknown
    ];
'transactions/archived': [
        [
            Select_transactions_archived
        ],
        Transactions
    ];
'transactions/between': [
        [
            Select_transactions_between
        ],
        Transactions
    ];
'transactions/deposits': [
        [
            Select_transactions_deposits
        ],
        Transactions
    ];
...
'transactions/new': [
        [
            Insert_transactions_new
        ],
        unknown
    ];
'transactions/set-archive': [
        [
            Update_transactions_set_archive
        ],
        unknown
    ];
...
'types/all-subtypes': [
        [
            Select_types_all_subtypes
        ],
        Subtypes
    ];
'types/all-types': [
        [
            Select_types_all_types
        ],
        TransactionTypes
    ];
'types/new-subtype': [
        [
            Insert_types_new_subtype
        ],
        unknown
    ];
'types/new-type': [
        [
            Insert_types_new_type
        ],
        unknown
    ];
'types/subtype-from-type': [
        [
            Select_types_subtype_from_type
        ],
        Subtypes
    ];
'types/update-subtype': [
        [
            Update_types_update_subtype
        ],
        unknown
    ];
'types/update-type': [
        [
            Update_types_update_type
        ],
        unknown
    ];
'types/type-from-id': [
...
'balance-correction/delete': [
        [
            Delete_balance_correction_delete
        ],
        unknown
    ];
...
'budgets/budget-from-id': [
        [
            Select_budgets_budget_from_id
        ],
        Budgets
    ];
...
'budgets/new-budget': [
        [
            Insert_budgets_new_budget
        ],
        unknown
    ];
'budgets/update-budget': [
        [
            Update_budgets_update_budget
        ],
        unknown
    ];
'budgets/all': [
...
'goals/from-id': [
        [
            Select_goals_from_id
        ],
        Goals
    ];
'goals/get-bucket-goals': [
        [
...
'goals/remove-bucket-goals': [
        [
            Delete_goals_remove_bucket_goals
        ],
        unknown
    ];

[![Build](https://github.com/tsaxking/template-budgeting/actions/workflows/build.yml/badge.svg)](https://github.com/tsaxking/template-budgeting/actions/workflows/build.yml) [![Backend](https://github.com/tsaxking/template-budgeting/actions/workflows/backend.yml/badge.svg)](https://github.com/tsaxking/template-budgeting/actions/workflows/backend.yml) [![e2e](https://github.com/tsaxking/template-budgeting/actions/workflows/e2e.yml/badge.svg)](https://github.com/tsaxking/template-budgeting/actions/workflows/e2e.yml) [![Formatter](https://github.com/tsaxking/template-budgeting/actions/workflows/formatter.yml/badge.svg)](https://github.com/tsaxking/template-budgeting/actions/workflows/formatter.yml) [![Linter](https://github.com/tsaxking/template-budgeting/actions/workflows/linter.yml/badge.svg)](https://github.com/tsaxking/template-budgeting/actions/workflows/linter.yml) [![Typescript](https://github.com/tsaxking/template-budgeting/actions/workflows/tsc.yml/badge.svg)](https://github.com/tsaxking/template-budgeting/actions/workflows/tsc.yml)
...
```bash
# fork the repository
git clone https://github.com/tsaxking/template-budgeting.git
cd webpack-template
